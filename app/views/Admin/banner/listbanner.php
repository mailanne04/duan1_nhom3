      ...
      <section class="content-header">
        ...
        <div class="card-footer">
          <a href="AdminController.php?act=adddm">
            ...
            <button class="btn btn-primary">Tạo banner mới</button>
          </a>
        </div>
      </section>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <tr>
                        <td>hehe</td>
                        <td><img src="../../public/img/avatar2.png" alt="" style="width:100px"></td>
                        <td>ndshvbwrcekrbevhk</td>
                        <td>
                        <a href="#"><button type="button" class="btn btn-outline-primary">Xem
                          chi tiết</button></a>
